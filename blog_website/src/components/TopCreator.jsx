                        ...
                        >
                            <div className='flex justify-between items-center mt-2 gap-3'>
                                ...
                                <button
                                    ...
                                    className='text-xs text-white bg-gray-900 dark:bg-gray-800 px-3 py-2 rounded-full hover:bg-gray-800 dark:hover:bg-gray-700 hover:-translate-y-1.5 duration-200 hover:transition-all cursor-pointer'
                                >
                                    Follow
                                </button>
                            </div>
