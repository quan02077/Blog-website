    ...
    return (
        <header className="grid grid-cols-3 gap-4 p-4 border-b border-gray-300 dark:border-gray-800 shadow-md sticky top-0 bg-white dark:bg-[#1a1d27] z-10 shrink-0">
            ...
            <div className="col-span-1 flex justify-end items-center gap-4">
                <button className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 hover:transition-all duration-200 hover:-translate-y-1.5 hover:shadow-lg cursor-pointer text-gray-700 dark:text-gray-300" title="Chế độ tối">
                ...
                <button className="w-fit h-fit rounded-full border border-gray-300 dark:border-blue-500 bg-blue-500 px-4 py-2 text-white font-medium hover:bg-blue-900 hover:transition-all duration-200 hover:-translate-y-1.5 hover:underline cursor-pointer hover:shadow-lg dark:shadow-blue-900/20">Đăng nhập/Đăng ký</button>
            </div>
        </header>
    )
}
