...
function DraftEmptyState() {
    return (
        <div className="bg-white dark:bg-[#1a1d27] rounded-2xl border border-gray-200 dark:border-gray-800 p-16 flex flex-col items-center text-center">
            <div className="w-20 h-20 rounded-3xl bg-gray-100 dark:bg-[#0f1117] flex items-center justify-center mb-5">
